...
const FFMPEG_CANDIDATES: &[&str] = &["ffmpeg", "ffmpeg-aarch64-apple-darwin", "ffmpeg-x86_64-apple-darwin"];

#[cfg(target_os = "windows")]
const FFPROBE_CANDIDATES: &[&str] = &["ffprobe.exe", "ffprobe-x86_64-pc-windows-msvc.exe"];
#[cfg(not(target_os = "windows"))]
const FFPROBE_CANDIDATES: &[&str] = &["ffprobe", "ffprobe-aarch64-apple-darwin", "ffprobe-x86_64-apple-darwin"];
